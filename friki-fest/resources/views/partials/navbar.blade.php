<nav>
    ...
    <a href="{{ route('comics') }}" class="{{ request()->routeIs('comics') ? 'activo' : '' }}">Cómics</a>
    <a href="{{ route('anime') }}" class="{{ request()->routeIs('anime') ? 'activo' : '' }}">Anime</a>
    <a href="{{ route('videojuegos') }}" class="{{ request()->routeIs('videojuegos') ? 'activo' : '' }}">Videojuegos</a>
