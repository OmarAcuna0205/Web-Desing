...
class GerenteController extends Controller
{
    ...
    public function reportes() {
        $porCategoria = Ticket::selectRaw('categoria, count(*) as total')->groupBy('categoria')->get();
        $porUrgencia = Ticket::selectRaw('nivel_urgencia, count(*) as total')->groupBy('nivel_urgencia')->get();
