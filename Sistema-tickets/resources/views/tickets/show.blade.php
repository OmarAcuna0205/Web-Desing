    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <strong>{{ $ticket->fecha_promesa ? $ticket->fecha_promesa->format('d/m/Y H:i') : '-' }}</strong>
                    </div>
                    <div class="col-md-4">
                        <p class="mb-1 text-muted small">Fecha Resolución</p>
                        <strong>{{ $ticket->fecha_resolucion ? $ticket->fecha_resolucion->format('d/m/Y H:i') : '-' }}</strong>
                    </div>
                </div>
            </div>
            <div class="card-footer d-flex gap-2">
                ...
                <form action="{{ route('tickets.destroy', $ticket) }}" method="POST" class="ms-auto" onsubmit="return confirm('¿Eliminar?')">
                    @csrf
                    @method('DELETE')
